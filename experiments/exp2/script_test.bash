    ...
    do
        ...
        do
            ...
            do
                ...
                for Th in "${Ths[@]}"
                do
                    mkdir -p "../save_exp/$len2/rate_$rate/$temp_ini/$Th"
                    echo "----- len2: $len2 rate: $rate temp_ini: $temp_ini rep: $repeat th: $Th de 30 ----"
                    ((seed+=$repeat*2))
                    ...
                    ./s3e2_sas $temp_ini 0.00000009 $seed 15 30 25 $rate -1 -1 -1 1 $len2 -1 -1 $Th -1 -1 "../save_exp/$len2/rate_$rate/$temp_ini/$Th" "$repeat" "exp2"
                done
            done
        done
    done
