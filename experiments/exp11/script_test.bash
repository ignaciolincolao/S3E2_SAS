        ...
        do
            ...
            do
                ...
                do
                    ...
                    echo "----- len2: $len4 rate: $rate temp_ini: $temp_ini rep: $repeat de 30 ----"
                    ((seed+=$repeat*2))
                    ...
                    ./s3e2_sas $temp_ini 0.00000009 $seed 15 30 25 $rate -1 -1 -1 -1 -1 1.1 $len4 $Th -1 -1 "../save_exp/$len4/rate_$rate/$temp_ini/$Th/" "$repeat" "exp11"
                done
            done
        done
    done
