        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        line=$(head -n 1 "./save_exp/$len2/rate_$rate/$temp_ini/$reheating/$e_const/$repeat-info-test.txt")
                        line+=",./save_exp/$len2/rate_$rate/$temp_ini/$reheating/$e_const/$repeat-info-test.txt"
