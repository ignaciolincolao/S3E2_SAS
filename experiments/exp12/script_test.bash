...
do 
    ...
    do
        ...
        do
            ...
            do
                mkdir -p "../save_exp/$len4/rate_$rate/$temp_ini"
                ...
                ./s3e2_sas $temp_ini 0.00000009 $seed 15 30 25 $rate -1 -1 -1 -1 -1 1.1 $len4 -1 -1 -1 "../save_exp/$len4/rate_$rate/$temp_ini/" "$repeat" "exp12"
            done
        done
    done
done
echo "fin de ----- len4: $len4 rate: $rate temp_ini: $temp_ini rep: $repeat de 30 ----"
