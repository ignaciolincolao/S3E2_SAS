...
double sasFunc() {
    ...
    */
    ...
    int countFromNewSolution = 0;
    int maxCountFromNewSolution = (n_colegios-1)*n_students;
    double bestTemp = 0;
    ...
    while(stoppingCS9(countFromNewSolution,maxCountFromNewSolution)){
